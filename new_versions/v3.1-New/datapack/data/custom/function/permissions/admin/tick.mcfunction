...
execute as @a[scores={ap_sit=1..},tag=Admin] run function custom:permissions/admin/commands/sit/run
scoreboard players set @a[scores={ap_sit=1..}] ap_sit 0
...
# Diğer
# ═══════════════════════════════════════════════════
function custom:permissions/vip/commands/tick/tick with storage glc_menu:names temp