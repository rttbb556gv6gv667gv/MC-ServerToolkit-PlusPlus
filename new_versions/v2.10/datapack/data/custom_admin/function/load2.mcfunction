...
execute unless entity @s[tag=Admin] run function custom:permissions/player/init
...
tellraw @a[tag=Admin] ["["," ",{"text":"Stop","click_event":{"action":"run_command","command":"/function custom_admin:stop"},"hover_event":{"action":"show_text","value":"Click to Stop!"}}," ","]"]
