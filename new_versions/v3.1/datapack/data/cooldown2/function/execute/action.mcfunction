...
# Kullanım: /function cooldown:execute/action {id:"player_name",file:"myfunc:file",arguments:{}}
...
$execute if entity $(id) unless score $(id) cd.active matches 1.. run function $(file) $(arguments)
