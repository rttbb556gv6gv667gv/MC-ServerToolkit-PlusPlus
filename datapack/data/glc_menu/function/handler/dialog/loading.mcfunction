...
dialog show @s {type:"minecraft:notice",title:"",body:{type:"minecraft:plain_message",contents:{text:"\n\n\n\n\n\n\nHazırlanıyor...\n\n",bold:1b,italic:0b}},can_close_with_escape:0b,pause:0b,after_action:"none",action:{label:"İptal",action:{type:"minecraft:run_command",command:"/function glc_menu:handler/close"}}}
